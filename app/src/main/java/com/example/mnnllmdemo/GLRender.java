...
public class GLRender implements GLSurfaceView.Renderer {
    ...
    public static final float depth_adjust_factor = 0.5f;                                    // Please adjust it by yourself to get more depth accuracy. This factor should be optimized by making it a function of focal distance rather than maintaining it as a constant.
    ...
    private static LinkedList<Classifier.Recognition> Post_Process_Yolo(float[] outputs) {
        ...
        for (int i = 0; i < yolo_num_boxes; ++i) {
            ...
            if (maxScore >= yolo_detect_threshold) {
                ...
                float[] coordinates = {rect.left, rect.top, rect.right, rect.bottom};
            }
